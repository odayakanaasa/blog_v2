...
class Wechat
{
    ...
    /**
     * 构造函数
     * @param  String $fromUsername 来自谁
     * @param  String $toUsername 发给谁
     * @param  String $time 响应时间
     * @return void
     */
    public function __construct($fromUsername, $toUsername, $time)
    {
...
// $robot = new \Turing_Robot\Wechat($fromUsername, $toUsername, $time);
// echo $robot->analysis($content);
